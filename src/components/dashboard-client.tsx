...
import { User, Mail, Phone, Home, Calendar, BookOpen, GraduationCap } from 'lucide-react';
...
export default function DashboardClient({ student, bills }: DashboardClientProps) {
